...
$(document).ready(function(){
        var total = 0;
        $( "#cart-sidebar .row").each(function() {
           var price = $(this).find( ".productItemPrice" ).text();
           var qts   = $(this).find( ".productItemQuantity" ).text();
          total += price*qts;
        });
        $('.cart-total-right.money i').append(total);
});
...
//$(document).ready(function(){
//        var totalo = 0;
//        $( ".checkoutcart #item").each(function() {
//           var price = $(this).find( ".price" ).text();
//           var qts   = $(this).find( ".qts b" ).text();
//           totalo += price*qts;
//        });
//        $( ".checkoutcart .total").html(totalo);
//});
...
$('#contact_form').submit(function() {
     ...
     if(res == false){
         $('.Contactjs').show();
         $('.Contactjs').html("Please Fill The Required Fields");
     }
     return res; 
});
...
$('#RegisterForm').submit(function() {
     ...
     if(res == false){
         $('.registerjs').show();
         $('.registerjs').html("Please Fill The Required Fields");
     }
     return res; 
});
...
$('#Subscribe').submit(function() {
     ...
     if(res == false){
         $('.Resetjs').show();
         $('.Resetjs').html("Please insert your email");
         $(".Resetjs").fadeOut(7000);
     }
...
$('#LoginForm').submit(function() {
     ...
     if(res == false){
         $('.loginjs').show();
         $('.loginjs').html("Please Fill The Required Fields");
     }
     return res; // returning false will prevent the form from submitting.
});


$(document).on('click', '.productaction #addtocartajax', function() {
    $(this).remove();
    var pr = $(this).attr('data-productid');
    $('.productaction').prepend('<a href="javascript:void(0);" data-productID="'+pr+'" id="deletecartajax"><i class="fa fa-check" aria-hidden="true"></i> Added to cart</a>')
});

$(document).on('click', '.productaction #deletecartajax', function() {
    $(this).remove();
    var pr = $(this).attr('data-productid');
    $('.productaction').prepend('<a href="javascript:void(0);" data-productID="'+pr+'" id="addtocartajax"><i class="fa fa-shopping-bag" aria-hidden="true"></i> Add to cart</a>')
});
...
$(document).on('click', 'body #addtoWishList', function() {


$(this).css({ background: "#e04a3f" });
$(this).css({ color: "white" });
$(this).attr("id","deletewishlistajax");
...
$(document).on('click', 'body #clearcartajax', function() {
    $('.cart_count').html('0')
    $('[id*=cart-product-]').remove();
...
$(document).on('click', 'body #deletecartajax', function() {
    
    // get the product
    var product = $(this).attr('data-productID');   
    
    // reduce the amount of products in header cart
    $total = parseInt($('#cart-header .cart_count').text(), 10)-1;
    $('#cart-header .cart_count').html($total);
    
    // get the price of the product
    var pr = $('#cart-header #cart-product-'+product+' .productItemPrice').text();
    var price = parseInt(pr, 10);
   
    // get the total price of header product
    var total = $('.cart-total-right.money i').text();
    
    var totalprice = parseInt(total, 10);
    
    // reduce the product from total
    var main = totalprice-price;
    
    
    // change the price in the cart
    $('.cart-total-right.money i').html(main);
    
    // Remove the product from Header cart
    $('#cart-header').find('#cart-product-'+product).remove();
    
    // Remove the product from shopping cart
    $('#shopping-cart-table').find('#cart-product-'+product).remove();
...
$(document).on('click', 'body #deletewishlistajax', function() {
...
$(this).css({ background: "" });
$(this).css({ color: "" });
$(this).attr("id","addtoWishList");
    
    // Remove the product from wishlist table
    $('#wishlistable').find('#wish-product-'+product).remove();
    
    
    
    
    // Remove the product from wishslist table
    var pr = $('#wislist-item-'+product).remove();
...
formData.append('product', product);   
    ...
    if($('#cart-sidebar #cart-product-'+product).length){
...
$('#cart-sidebar').append('<div class="row" id="cart-product-'+product.id+'"><a class="cart-close" data-productid="'+product.id+'" id="deletecartajax" href="javascript:;"><i class="fa fa-times"></i></a><div class="cart-left"><a class="cart-image" href="javascript:;"><img src="/uploads/products/'+product.thumbnail+'"></a></div><div class="cart-right"><div class="cart-title"><a href="javascript:;">'+product.name+'</a></div><div class="cart-price"><span class="money">'+product.price+'</span><span class="x"> x <span class="drb">'+product.q+'</span></span></div></div></div>');
            

            $total = parseInt($('#cart-header .cart_count').text(), 10)+1;
            $amout = $('.cart-total-right i').text();
            $amout = parseInt($amout, 10);

            $pr = parseInt(product.price, 10);
            $('.cart-total-right.money i').html($amout+$pr);
...
$(document).ready(function(){
    $( "#shopping-cart-table .cartitem").each(function() {
       var price = $(this).find( ".productItemPrice" ).text();
       var qts   = $(this).find( ".productItemQuantity" ).val();
       $(this).find('.Productsubtotal').html(price*qts+'$');
    });
});
...
$(document).ready(function(){
        var total = 0;
        $( ".lmajmo3 .cartlibayna").each(function() {
           var price = $(this).find( ".money" ).text();
           var qts   = $(this).find( ".drb" ).text();
          total += price*qts;
        });
        $('.lmajmo3 .subtotal .money').append(total);
});
...
$(document).ready(function(){
        ...
        $( ".checkoutcart #item").each(function() {
           var price = $(this).find( ".price" ).text();
           var qts   = $(this).find( ".qts" ).text();
           $(this).find( ".subtotal" ).html('$'+price*qts);
           totalo += price*qts;
            
        });
        $( ".alltotaltopay").html('$'+totalo);
});
